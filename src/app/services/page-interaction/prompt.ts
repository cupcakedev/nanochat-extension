...
export function buildInteractionPrompt(params: {
  ...
  return [
    ...
    'If finalAnswer contains a URL different from Current URL, status must be continue and actions must start with openUrl to that URL.',
    'Actions are executed in listed order.',
    'Use openUrl with an absolute http/https URL for global navigation to a known destination.',
