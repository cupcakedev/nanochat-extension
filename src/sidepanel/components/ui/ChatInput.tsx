...
import { useImageAttachments } from '@sidepanel/hooks/chat';
import { useTextareaAutoResize } from '@sidepanel/hooks/ui';
import type { ChatContextSendMode, ChatMode, ChatSendOptions } from '@sidepanel/types/mode';
